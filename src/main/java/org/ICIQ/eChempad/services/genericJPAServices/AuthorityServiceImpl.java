...
@Service
public class AuthorityServiceImpl<T extends EntityImpl, S extends Serializable> extends GenericServiceImpl<Authority, UUID> implements AuthorityService<Authority, UUID> {
